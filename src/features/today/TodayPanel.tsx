...
export function TodayPanel({ onNavigate }: TodayPanelProps) {
  ...
  // 今日到期任务：deadline 时间戳落在今天（含已逾期未完成）
  ...
  // 今日有效习惯（checkIns 变化触发重渲染，getter 读取最新状态）
  void checkIns;
  void reviews;
  ...
  // 复盘：getAllReviews 已过滤空内容/无评分的记录
